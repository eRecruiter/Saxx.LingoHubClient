...
namespace Saxx.LingoHubClient
{
    public partial class LingoHubClient
    {
        ...
        {
            var json = JsonConvert.DeserializeObject<JObject>(await FetchAsString("projects.json"));
        ...
        {
            return JsonConvert.DeserializeObject<ProjectDetails>(await FetchAsString(project.Href + ".json"));
        }
    }
}